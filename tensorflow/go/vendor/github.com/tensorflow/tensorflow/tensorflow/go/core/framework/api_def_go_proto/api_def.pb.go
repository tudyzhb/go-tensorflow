...
package api_def_go_proto // import "github.com/tensorflow/tensorflow/tensorflow/go/core/framework/api_def_go_proto"
...
func (ApiDef_Visibility) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_api_def_3d99bf66ee00f367, []int{0, 0}
}
...
func (*ApiDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_def_3d99bf66ee00f367, []int{0}
}
...
func (*ApiDef_Arg) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_def_3d99bf66ee00f367, []int{0, 1}
}
...
func (*ApiDef_Attr) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_def_3d99bf66ee00f367, []int{0, 2}
}
...
func (*ApiDefs) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_def_3d99bf66ee00f367, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/api_def.proto", fileDescriptor_api_def_3d99bf66ee00f367)
}

var fileDescriptor_api_def_3d99bf66ee00f367 = []byte{
