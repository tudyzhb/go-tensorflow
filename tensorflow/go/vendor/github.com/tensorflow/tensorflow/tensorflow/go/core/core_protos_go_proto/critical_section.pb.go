...
func (*CriticalSectionDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_critical_section_0d7faab588a9f5b5, []int{0}
}
...
func (*CriticalSectionExecutionDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_critical_section_0d7faab588a9f5b5, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/critical_section.proto", fileDescriptor_critical_section_0d7faab588a9f5b5)
}

var fileDescriptor_critical_section_0d7faab588a9f5b5 = []byte{
