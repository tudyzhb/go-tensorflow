...
package tensor_shape_go_proto // import "github.com/tensorflow/tensorflow/tensorflow/go/core/framework/tensor_shape_go_proto"
...
func (*TensorShapeProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_shape_fa093934c78abe2e, []int{0}
}
...
func (*TensorShapeProto_Dim) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_shape_fa093934c78abe2e, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/tensor_shape.proto", fileDescriptor_tensor_shape_fa093934c78abe2e)
}

var fileDescriptor_tensor_shape_fa093934c78abe2e = []byte{
