...
import tensor_slice_go_proto "github.com/tensorflow/tensorflow/tensorflow/go/core/framework/tensor_slice_go_proto"
...
func (BundleHeaderProto_Endianness) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_tensor_bundle_a01d288b61bc86ee, []int{0, 0}
}
...
func (*BundleHeaderProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_bundle_a01d288b61bc86ee, []int{0}
}
...
func (*BundleEntryProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_bundle_a01d288b61bc86ee, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/tensor_bundle.proto", fileDescriptor_tensor_bundle_a01d288b61bc86ee)
}

var fileDescriptor_tensor_bundle_a01d288b61bc86ee = []byte{
