...
func (*NamedTensorProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_named_tensor_f8a2db6eb50578e0, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/named_tensor.proto", fileDescriptor_named_tensor_f8a2db6eb50578e0)
}

var fileDescriptor_named_tensor_f8a2db6eb50578e0 = []byte{
