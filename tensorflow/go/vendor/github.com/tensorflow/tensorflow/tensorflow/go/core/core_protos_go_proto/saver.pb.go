...
func (SaverDef_CheckpointFormatVersion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_saver_c9487a4e338e2f53, []int{0, 0}
}
...
func (*SaverDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_saver_c9487a4e338e2f53, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/saver.proto", fileDescriptor_saver_c9487a4e338e2f53)
}

var fileDescriptor_saver_c9487a4e338e2f53 = []byte{
