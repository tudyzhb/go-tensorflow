...
import fmt "fmt"
import math "math"
import stream_executor "github.com/tensorflow/tensorflow/tensorflow/go/stream_executor"
...
func (*ConvolutionProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_conv_autotuning_9b37865cd574510a, []int{0}
}
...
func (dst *ConvolutionProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConvolutionProto.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/conv_autotuning.proto", fileDescriptor_conv_autotuning_9b37865cd574510a)
}

var fileDescriptor_conv_autotuning_9b37865cd574510a = []byte{
