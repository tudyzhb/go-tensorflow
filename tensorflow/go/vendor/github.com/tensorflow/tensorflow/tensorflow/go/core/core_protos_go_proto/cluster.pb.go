...
func (*JobDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_2c54611a3b0b51c1, []int{0}
}
...
func (*ClusterDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_2c54611a3b0b51c1, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/cluster.proto", fileDescriptor_cluster_2c54611a3b0b51c1)
}

var fileDescriptor_cluster_2c54611a3b0b51c1 = []byte{
