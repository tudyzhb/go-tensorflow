...
func (*MemAllocatorStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_bfc_memory_map_6160d9011207bba7, []int{0}
}
...
func (*MemChunk) Descriptor() ([]byte, []int) {
	return fileDescriptor_bfc_memory_map_6160d9011207bba7, []int{1}
}
...
func (*BinSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_bfc_memory_map_6160d9011207bba7, []int{2}
}
...
func (*SnapShot) Descriptor() ([]byte, []int) {
	return fileDescriptor_bfc_memory_map_6160d9011207bba7, []int{3}
}
...
func (*MemoryDump) Descriptor() ([]byte, []int) {
	return fileDescriptor_bfc_memory_map_6160d9011207bba7, []int{4}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/bfc_memory_map.proto", fileDescriptor_bfc_memory_map_6160d9011207bba7)
}

var fileDescriptor_bfc_memory_map_6160d9011207bba7 = []byte{
