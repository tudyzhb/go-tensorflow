...
package reader_base_go_proto // import "github.com/tensorflow/tensorflow/tensorflow/go/core/framework/reader_base_go_proto"
...
func (*ReaderBaseState) Descriptor() ([]byte, []int) {
	return fileDescriptor_reader_base_9609523a127d1626, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/reader_base.proto", fileDescriptor_reader_base_9609523a127d1626)
}

var fileDescriptor_reader_base_9609523a127d1626 = []byte{
