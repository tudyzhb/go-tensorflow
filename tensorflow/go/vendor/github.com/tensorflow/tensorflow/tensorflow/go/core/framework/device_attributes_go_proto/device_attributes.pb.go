...
package device_attributes_go_proto // import "github.com/tensorflow/tensorflow/tensorflow/go/core/framework/device_attributes_go_proto"
...
func (*InterconnectLink) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_attributes_6388918ec8b1e889, []int{0}
}
...
func (*LocalLinks) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_attributes_6388918ec8b1e889, []int{1}
}
...
func (*DeviceLocality) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_attributes_6388918ec8b1e889, []int{2}
}
...
func (*DeviceAttributes) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_attributes_6388918ec8b1e889, []int{3}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/device_attributes.proto", fileDescriptor_device_attributes_6388918ec8b1e889)
}

var fileDescriptor_device_attributes_6388918ec8b1e889 = []byte{
