...
package stream_executor // import "github.com/tensorflow/tensorflow/tensorflow/go/stream_executor"
...
func (DataType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_dnn_8c95c40b2dbc6c0f, []int{0}
}
...
func (DataLayout) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_dnn_8c95c40b2dbc6c0f, []int{1}
}
...
func (FilterLayout) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_dnn_8c95c40b2dbc6c0f, []int{2}
}
...
func (ActivationMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_dnn_8c95c40b2dbc6c0f, []int{3}
}
...
func (ConvolutionMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_dnn_8c95c40b2dbc6c0f, []int{4}
}
...
func (ConvolutionKind) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_dnn_8c95c40b2dbc6c0f, []int{5}
}
...
func (AlgorithmProto_MathType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_dnn_8c95c40b2dbc6c0f, []int{1, 0}
}
...
func (dst *TensorDescriptorProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TensorDescriptorProto.Merge(dst, src)
}
...
func (*TensorDescriptorProto) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _TensorDescriptorProto_OneofMarshaler, _TensorDescriptorProto_OneofUnmarshaler, _TensorDescriptorProto_OneofSizer, []interface{}{
		(*TensorDescriptorProto_DataLayout)(nil),
		(*TensorDescriptorProto_FilterLayout)(nil),
	}
}

func _TensorDescriptorProto_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*TensorDescriptorProto)
	// layout_oneof
	switch x := m.LayoutOneof.(type) {
	case *TensorDescriptorProto_DataLayout:
		b.EncodeVarint(3<<3 | proto.WireVarint)
		b.EncodeVarint(uint64(x.DataLayout))
	case *TensorDescriptorProto_FilterLayout:
		b.EncodeVarint(4<<3 | proto.WireVarint)
		b.EncodeVarint(uint64(x.FilterLayout))
	case nil:
	default:
		return fmt.Errorf("TensorDescriptorProto.LayoutOneof has unexpected type %T", x)
	}
	return nil
}

func _TensorDescriptorProto_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*TensorDescriptorProto)
	switch tag {
	case 3: // layout_oneof.data_layout
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.LayoutOneof = &TensorDescriptorProto_DataLayout{DataLayout(x)}
		return true, err
	case 4: // layout_oneof.filter_layout
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.LayoutOneof = &TensorDescriptorProto_FilterLayout{FilterLayout(x)}
		return true, err
	default:
		return false, nil
	}
...
func _TensorDescriptorProto_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*TensorDescriptorProto)
	// layout_oneof
	switch x := m.LayoutOneof.(type) {
	case *TensorDescriptorProto_DataLayout:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(x.DataLayout))
	case *TensorDescriptorProto_FilterLayout:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(x.FilterLayout))
	case nil:
	default:
...
func (dst *AlgorithmProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AlgorithmProto.Merge(dst, src)
}
...
func (dst *ConvolutionDescriptorProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConvolutionDescriptorProto.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/stream_executor/dnn.proto", fileDescriptor_dnn_8c95c40b2dbc6c0f)
}

var fileDescriptor_dnn_8c95c40b2dbc6c0f = []byte{
