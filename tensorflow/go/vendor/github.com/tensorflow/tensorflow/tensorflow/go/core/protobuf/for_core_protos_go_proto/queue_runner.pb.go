...
func (*QueueRunnerDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_queue_runner_f26f7fb3d4bc3e14, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/queue_runner.proto", fileDescriptor_queue_runner_f26f7fb3d4bc3e14)
}

var fileDescriptor_queue_runner_f26f7fb3d4bc3e14 = []byte{
