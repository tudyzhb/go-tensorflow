...
func (*TaskDeviceFilters) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_filters_e8b2fd246f893df5, []int{0}
}
...
func (*JobDeviceFilters) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_filters_e8b2fd246f893df5, []int{1}
}
...
func (*ClusterDeviceFilters) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_filters_e8b2fd246f893df5, []int{2}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/device_filters.proto", fileDescriptor_device_filters_e8b2fd246f893df5)
}

var fileDescriptor_device_filters_e8b2fd246f893df5 = []byte{
