...
package op_def_go_proto // import "github.com/tensorflow/tensorflow/tensorflow/go/core/framework/op_def_go_proto"
...
func (*OpDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_op_def_11bc6e9aad134181, []int{0}
}
...
func (*OpDef_ArgDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_op_def_11bc6e9aad134181, []int{0, 0}
}
...
func (*OpDef_AttrDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_op_def_11bc6e9aad134181, []int{0, 1}
}
...
func (*OpDeprecation) Descriptor() ([]byte, []int) {
	return fileDescriptor_op_def_11bc6e9aad134181, []int{1}
}
...
func (*OpList) Descriptor() ([]byte, []int) {
	return fileDescriptor_op_def_11bc6e9aad134181, []int{2}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/op_def.proto", fileDescriptor_op_def_11bc6e9aad134181)
}

var fileDescriptor_op_def_11bc6e9aad134181 = []byte{
