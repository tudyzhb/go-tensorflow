...
func (*ResourceDtypeAndShape) Descriptor() ([]byte, []int) {
	return fileDescriptor_remote_tensor_handle_e9b99f98654c2fae, []int{0}
}
...
func (*RemoteTensorHandle) Descriptor() ([]byte, []int) {
	return fileDescriptor_remote_tensor_handle_e9b99f98654c2fae, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/remote_tensor_handle.proto", fileDescriptor_remote_tensor_handle_e9b99f98654c2fae)
}

var fileDescriptor_remote_tensor_handle_e9b99f98654c2fae = []byte{
