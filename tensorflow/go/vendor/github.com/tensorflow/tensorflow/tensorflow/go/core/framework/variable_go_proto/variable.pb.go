...
package variable_go_proto // import "github.com/tensorflow/tensorflow/tensorflow/go/core/framework/variable_go_proto"
...
func (VariableSynchronization) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_variable_71eeb1c3683a0a7e, []int{0}
}
...
func (VariableAggregation) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_variable_71eeb1c3683a0a7e, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/variable.proto", fileDescriptor_variable_71eeb1c3683a0a7e)
}

var fileDescriptor_variable_71eeb1c3683a0a7e = []byte{
