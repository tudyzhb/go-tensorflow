...
func (BundleHeaderProto_Endianness) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_tensor_bundle_fa171441dafcd21a, []int{0, 0}
}
...
func (*BundleHeaderProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_bundle_fa171441dafcd21a, []int{0}
}
...
func (*BundleEntryProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_bundle_fa171441dafcd21a, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/tensor_bundle.proto", fileDescriptor_tensor_bundle_fa171441dafcd21a)
}

var fileDescriptor_tensor_bundle_fa171441dafcd21a = []byte{
