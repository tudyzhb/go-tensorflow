...
func (*DebugTensorWatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_debug_ebe151dfa64084e8, []int{0}
}
...
func (*DebugOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_debug_ebe151dfa64084e8, []int{1}
}
...
func (*DebuggedSourceFile) Descriptor() ([]byte, []int) {
	return fileDescriptor_debug_ebe151dfa64084e8, []int{2}
}
...
func (dst *DebuggedSourceFile) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DebuggedSourceFile.Merge(dst, src)
}
...
func (*DebuggedSourceFiles) Descriptor() ([]byte, []int) {
	return fileDescriptor_debug_ebe151dfa64084e8, []int{3}
}
...
func (dst *DebuggedSourceFiles) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DebuggedSourceFiles.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/debug.proto", fileDescriptor_debug_ebe151dfa64084e8)
}

var fileDescriptor_debug_ebe151dfa64084e8 = []byte{
