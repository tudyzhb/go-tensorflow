...
func (OptimizerOptions_Level) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_config_5faca95361cbb717, []int{1, 0}
}
...
func (OptimizerOptions_GlobalJitLevel) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_config_5faca95361cbb717, []int{1, 1}
}
...
func (ConfigProto_Experimental_MlirBridgeRollout) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_config_5faca95361cbb717, []int{6, 1, 0}
}
...
func (RunOptions_TraceLevel) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_config_5faca95361cbb717, []int{7, 0}
}
...
func (*GPUOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_5faca95361cbb717, []int{0}
}
...
func (*GPUOptions_Experimental) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_5faca95361cbb717, []int{0, 0}
}
...
func (*GPUOptions_Experimental_VirtualDevices) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_5faca95361cbb717, []int{0, 0, 0}
}
...
func (*OptimizerOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_5faca95361cbb717, []int{1}
}
...
func (*GraphOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_5faca95361cbb717, []int{2}
}
...
func (*ThreadPoolOptionProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_5faca95361cbb717, []int{3}
}
...
func (*RPCOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_5faca95361cbb717, []int{4}
}
...
func (*SessionMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_5faca95361cbb717, []int{5}
}
...
func (*ConfigProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_5faca95361cbb717, []int{6}
}
...
func (*ConfigProto_Experimental) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_5faca95361cbb717, []int{6, 1}
}
...
func (*RunOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_5faca95361cbb717, []int{7}
}
...
func (*RunOptions_Experimental_RunHandlerPoolOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_5faca95361cbb717, []int{7, 0, 0}
}
...
func (*RunMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_5faca95361cbb717, []int{8}
}
...
func (*RunMetadata_FunctionGraphs) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_5faca95361cbb717, []int{8, 0}
}
...
func (*TensorConnection) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_5faca95361cbb717, []int{9}
}
...
func (*CallableOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_5faca95361cbb717, []int{10}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/config.proto", fileDescriptor_config_5faca95361cbb717)
}

var fileDescriptor_config_5faca95361cbb717 = []byte{
