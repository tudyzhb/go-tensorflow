...
func (*DeviceProperties) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_properties_6dc6df5b3018c490, []int{0}
}
...
func (*NamedDevice) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_properties_6dc6df5b3018c490, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/device_properties.proto", fileDescriptor_device_properties_6dc6df5b3018c490)
}

var fileDescriptor_device_properties_6dc6df5b3018c490 = []byte{
