...
func (*GraphDebugInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_graph_debug_info_429b2fe087de0393, []int{0}
}
...
func (dst *GraphDebugInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GraphDebugInfo.Merge(dst, src)
}
...
func (*GraphDebugInfo_FileLineCol) Descriptor() ([]byte, []int) {
	return fileDescriptor_graph_debug_info_429b2fe087de0393, []int{0, 0}
}
...
func (dst *GraphDebugInfo_FileLineCol) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GraphDebugInfo_FileLineCol.Merge(dst, src)
}
...
func (*GraphDebugInfo_StackTrace) Descriptor() ([]byte, []int) {
	return fileDescriptor_graph_debug_info_429b2fe087de0393, []int{0, 1}
}
...
func (dst *GraphDebugInfo_StackTrace) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GraphDebugInfo_StackTrace.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/graph_debug_info.proto", fileDescriptor_graph_debug_info_429b2fe087de0393)
}

var fileDescriptor_graph_debug_info_429b2fe087de0393 = []byte{
