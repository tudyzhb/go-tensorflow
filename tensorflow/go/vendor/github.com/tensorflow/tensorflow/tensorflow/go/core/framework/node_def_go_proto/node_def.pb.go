...
package node_def_go_proto // import "github.com/tensorflow/tensorflow/tensorflow/go/core/framework/node_def_go_proto"
...
func (*NodeDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_def_e0193187adfe5718, []int{0}
}
...
func (*NodeDef_ExperimentalDebugInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_def_e0193187adfe5718, []int{0, 1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/node_def.proto", fileDescriptor_node_def_e0193187adfe5718)
}

var fileDescriptor_node_def_e0193187adfe5718 = []byte{
