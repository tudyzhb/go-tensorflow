...
func (SaverDef_CheckpointFormatVersion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_saver_b64c08e8510446de, []int{0, 0}
}
...
func (*SaverDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_saver_b64c08e8510446de, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/saver.proto", fileDescriptor_saver_b64c08e8510446de)
}

var fileDescriptor_saver_b64c08e8510446de = []byte{
