...
func (*CriticalSectionDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_critical_section_ee22e4281c1816da, []int{0}
}
...
func (dst *CriticalSectionDef) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CriticalSectionDef.Merge(dst, src)
}
...
func (*CriticalSectionExecutionDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_critical_section_ee22e4281c1816da, []int{1}
}
...
func (dst *CriticalSectionExecutionDef) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CriticalSectionExecutionDef.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/critical_section.proto", fileDescriptor_critical_section_ee22e4281c1816da)
}

var fileDescriptor_critical_section_ee22e4281c1816da = []byte{
