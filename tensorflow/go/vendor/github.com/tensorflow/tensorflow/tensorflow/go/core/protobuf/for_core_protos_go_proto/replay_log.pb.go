...
func (*NewReplaySession) Descriptor() ([]byte, []int) {
	return fileDescriptor_replay_log_9037d6fda18ca10f, []int{0}
}
...
func (dst *NewReplaySession) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NewReplaySession.Merge(dst, src)
}
...
func (*ReplayOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_replay_log_9037d6fda18ca10f, []int{1}
}
...
func (dst *ReplayOp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReplayOp.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/replay_log.proto", fileDescriptor_replay_log_9037d6fda18ca10f)
}

var fileDescriptor_replay_log_9037d6fda18ca10f = []byte{
