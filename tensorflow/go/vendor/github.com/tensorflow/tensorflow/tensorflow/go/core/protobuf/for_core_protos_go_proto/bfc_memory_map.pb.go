...
func (*MemAllocatorStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_bfc_memory_map_670a4bfeb6c523a7, []int{0}
}
...
func (dst *MemAllocatorStats) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MemAllocatorStats.Merge(dst, src)
}
...
func (*MemChunk) Descriptor() ([]byte, []int) {
	return fileDescriptor_bfc_memory_map_670a4bfeb6c523a7, []int{1}
}
...
func (dst *MemChunk) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MemChunk.Merge(dst, src)
}
...
func (*BinSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_bfc_memory_map_670a4bfeb6c523a7, []int{2}
}
...
func (dst *BinSummary) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BinSummary.Merge(dst, src)
}
...
func (*SnapShot) Descriptor() ([]byte, []int) {
	return fileDescriptor_bfc_memory_map_670a4bfeb6c523a7, []int{3}
}
...
func (*MemoryDump) Descriptor() ([]byte, []int) {
	return fileDescriptor_bfc_memory_map_670a4bfeb6c523a7, []int{4}
}
...
func (dst *MemoryDump) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MemoryDump.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/bfc_memory_map.proto", fileDescriptor_bfc_memory_map_670a4bfeb6c523a7)
}

var fileDescriptor_bfc_memory_map_670a4bfeb6c523a7 = []byte{
