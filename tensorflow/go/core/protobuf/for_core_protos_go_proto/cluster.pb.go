...
func (*JobDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_dee884b45673dae6, []int{0}
}
...
func (*ClusterDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_dee884b45673dae6, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/cluster.proto", fileDescriptor_cluster_dee884b45673dae6)
}

var fileDescriptor_cluster_dee884b45673dae6 = []byte{
