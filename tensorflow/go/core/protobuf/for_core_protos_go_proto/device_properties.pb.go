...
func (*DeviceProperties) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_properties_8a57202d92749b35, []int{0}
}
...
func (*NamedDevice) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_properties_8a57202d92749b35, []int{1}
}
...
func (dst *NamedDevice) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NamedDevice.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/device_properties.proto", fileDescriptor_device_properties_8a57202d92749b35)
}

var fileDescriptor_device_properties_8a57202d92749b35 = []byte{
