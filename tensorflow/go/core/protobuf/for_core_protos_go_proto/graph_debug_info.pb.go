...
func (*GraphDebugInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_graph_debug_info_69d547f58168f3d1, []int{0}
}
...
func (*GraphDebugInfo_FileLineCol) Descriptor() ([]byte, []int) {
	return fileDescriptor_graph_debug_info_69d547f58168f3d1, []int{0, 0}
}
...
func (*GraphDebugInfo_StackTrace) Descriptor() ([]byte, []int) {
	return fileDescriptor_graph_debug_info_69d547f58168f3d1, []int{0, 1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/graph_debug_info.proto", fileDescriptor_graph_debug_info_69d547f58168f3d1)
}

var fileDescriptor_graph_debug_info_69d547f58168f3d1 = []byte{
