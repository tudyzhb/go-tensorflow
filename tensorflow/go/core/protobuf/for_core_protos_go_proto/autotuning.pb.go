...
func (AutotuneResult_FailureKind) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_autotuning_7358f8f66ebb2800, []int{2, 0}
}
...
func (*CudnnVersion) Descriptor() ([]byte, []int) {
	return fileDescriptor_autotuning_7358f8f66ebb2800, []int{0}
}
...
func (*ComputeCapability) Descriptor() ([]byte, []int) {
	return fileDescriptor_autotuning_7358f8f66ebb2800, []int{1}
}
...
func (*AutotuneResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_autotuning_7358f8f66ebb2800, []int{2}
}
...
func (dst *AutotuneResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AutotuneResult.Merge(dst, src)
}
...
func (*AutotuneResult) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _AutotuneResult_OneofMarshaler, _AutotuneResult_OneofUnmarshaler, _AutotuneResult_OneofSizer, []interface{}{
		(*AutotuneResult_Conv)(nil),
		(*AutotuneResult_Gemm)(nil),
	}
}

func _AutotuneResult_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*AutotuneResult)
	// key
	switch x := m.Key.(type) {
	case *AutotuneResult_Conv:
		b.EncodeVarint(5<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Conv); err != nil {
			return err
		}
	case *AutotuneResult_Gemm:
		b.EncodeVarint(6<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Gemm); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("AutotuneResult.Key has unexpected type %T", x)
	}
	return nil
}

func _AutotuneResult_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*AutotuneResult)
	switch tag {
	case 5: // key.conv
		...
		msg := new(AutotuneResult_ConvKey)
		err := b.DecodeMessage(msg)
		m.Key = &AutotuneResult_Conv{msg}
		return true, err
	case 6: // key.gemm
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(AutotuneResult_GemmKey)
		err := b.DecodeMessage(msg)
		m.Key = &AutotuneResult_Gemm{msg}
		return true, err
	default:
		return false, nil
	}
...
func _AutotuneResult_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*AutotuneResult)
	// key
	switch x := m.Key.(type) {
	case *AutotuneResult_Conv:
...
func (dst *AutotuneResult_FailureResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AutotuneResult_FailureResult.Merge(dst, src)
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*AutotuneResult_FailureResult) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _AutotuneResult_FailureResult_OneofMarshaler, _AutotuneResult_FailureResult_OneofUnmarshaler, _AutotuneResult_FailureResult_OneofSizer, []interface{}{
		(*AutotuneResult_FailureResult_ReferenceConv)(nil),
		(*AutotuneResult_FailureResult_ReferenceGemm)(nil),
	}
}

func _AutotuneResult_FailureResult_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*AutotuneResult_FailureResult)
	// key
	switch x := m.Key.(type) {
	case *AutotuneResult_FailureResult_ReferenceConv:
		b.EncodeVarint(11<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.ReferenceConv); err != nil {
			return err
		}
	case *AutotuneResult_FailureResult_ReferenceGemm:
		b.EncodeVarint(12<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.ReferenceGemm); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("AutotuneResult_FailureResult.Key has unexpected type %T", x)
	}
	return nil
}

func _AutotuneResult_FailureResult_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*AutotuneResult_FailureResult)
	switch tag {
	case 11: // key.reference_conv
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(AutotuneResult_ConvKey)
		err := b.DecodeMessage(msg)
		m.Key = &AutotuneResult_FailureResult_ReferenceConv{msg}
		return true, err
	case 12: // key.reference_gemm
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(AutotuneResult_GemmKey)
		err := b.DecodeMessage(msg)
		m.Key = &AutotuneResult_FailureResult_ReferenceGemm{msg}
		return true, err
	default:
		return false, nil
	}
...
func _AutotuneResult_FailureResult_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*AutotuneResult_FailureResult)
	// key
	switch x := m.Key.(type) {
	case *AutotuneResult_FailureResult_ReferenceConv:
		s := proto.Size(x.ReferenceConv)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *AutotuneResult_FailureResult_ReferenceGemm:
		s := proto.Size(x.ReferenceGemm)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (*AutotuneResult_ConvKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_autotuning_7358f8f66ebb2800, []int{2, 1}
}
...
func (dst *AutotuneResult_ConvKey) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AutotuneResult_ConvKey.Merge(dst, src)
}
...
func (*AutotuneResult_GemmKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_autotuning_7358f8f66ebb2800, []int{2, 2}
}
...
func (dst *AutotuneResult_GemmKey) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AutotuneResult_GemmKey.Merge(dst, src)
}
...
func (*AutotuningLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_autotuning_7358f8f66ebb2800, []int{3}
}
...
func (dst *AutotuningLog) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AutotuningLog.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/autotuning.proto", fileDescriptor_autotuning_7358f8f66ebb2800)
}

var fileDescriptor_autotuning_7358f8f66ebb2800 = []byte{
