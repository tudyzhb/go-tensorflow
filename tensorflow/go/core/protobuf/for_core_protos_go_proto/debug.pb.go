...
func (*DebugTensorWatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_debug_939e10d5a5bff8e1, []int{0}
}
...
func (*DebugOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_debug_939e10d5a5bff8e1, []int{1}
}
...
func (*DebuggedSourceFile) Descriptor() ([]byte, []int) {
	return fileDescriptor_debug_939e10d5a5bff8e1, []int{2}
}
...
func (*DebuggedSourceFiles) Descriptor() ([]byte, []int) {
	return fileDescriptor_debug_939e10d5a5bff8e1, []int{3}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/debug.proto", fileDescriptor_debug_939e10d5a5bff8e1)
}

var fileDescriptor_debug_939e10d5a5bff8e1 = []byte{
