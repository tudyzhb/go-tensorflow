...
func (RewriterConfig_Toggle) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_rewriter_config_625139df329953fb, []int{2, 0}
}
...
func (RewriterConfig_CpuLayout) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_rewriter_config_625139df329953fb, []int{2, 1}
}
...
func (RewriterConfig_NumIterationsType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_rewriter_config_625139df329953fb, []int{2, 2}
}
...
func (RewriterConfig_MemOptType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_rewriter_config_625139df329953fb, []int{2, 3}
}
...
func (*AutoParallelOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_rewriter_config_625139df329953fb, []int{0}
}
...
func (*ScopedAllocatorOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_rewriter_config_625139df329953fb, []int{1}
}
...
func (*RewriterConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_rewriter_config_625139df329953fb, []int{2}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/rewriter_config.proto", fileDescriptor_rewriter_config_625139df329953fb)
}

var fileDescriptor_rewriter_config_625139df329953fb = []byte{
