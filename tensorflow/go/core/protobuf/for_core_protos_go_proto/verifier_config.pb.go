...
func (VerifierConfig_Toggle) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_verifier_config_b725d9a9a12be986, []int{0, 0}
}
...
func (*VerifierConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_verifier_config_b725d9a9a12be986, []int{0}
}
...
func (dst *VerifierConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VerifierConfig.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/verifier_config.proto", fileDescriptor_verifier_config_b725d9a9a12be986)
}

var fileDescriptor_verifier_config_b725d9a9a12be986 = []byte{
