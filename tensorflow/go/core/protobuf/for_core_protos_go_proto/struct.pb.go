...
func (TypeSpecProto_TypeSpecClass) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_struct_1ef7ecbb1f4284ad, []int{9, 0}
}
...
func (*StructuredValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_struct_1ef7ecbb1f4284ad, []int{0}
}
...
func (*NoneValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_struct_1ef7ecbb1f4284ad, []int{1}
}
...
func (*ListValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_struct_1ef7ecbb1f4284ad, []int{2}
}
...
func (*TupleValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_struct_1ef7ecbb1f4284ad, []int{3}
}
...
func (*DictValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_struct_1ef7ecbb1f4284ad, []int{4}
}
...
func (*PairValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_struct_1ef7ecbb1f4284ad, []int{5}
}
...
func (*NamedTupleValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_struct_1ef7ecbb1f4284ad, []int{6}
}
...
func (*TensorSpecProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_struct_1ef7ecbb1f4284ad, []int{7}
}
...
func (*BoundedTensorSpecProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_struct_1ef7ecbb1f4284ad, []int{8}
}
...
func (*TypeSpecProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_struct_1ef7ecbb1f4284ad, []int{9}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/struct.proto", fileDescriptor_struct_1ef7ecbb1f4284ad)
}

var fileDescriptor_struct_1ef7ecbb1f4284ad = []byte{
