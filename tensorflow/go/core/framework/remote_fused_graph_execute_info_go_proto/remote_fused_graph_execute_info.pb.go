...
package remote_fused_graph_execute_info_go_proto // import "github.com/tensorflow/tensorflow/tensorflow/go/core/framework/remote_fused_graph_execute_info_go_proto"
...
func (*RemoteFusedGraphExecuteInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_remote_fused_graph_execute_info_3b0e7915e97ea4ec, []int{0}
}
...
func (*RemoteFusedGraphExecuteInfo_TensorShapeTypeProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_remote_fused_graph_execute_info_3b0e7915e97ea4ec, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/remote_fused_graph_execute_info.proto", fileDescriptor_remote_fused_graph_execute_info_3b0e7915e97ea4ec)
}

var fileDescriptor_remote_fused_graph_execute_info_3b0e7915e97ea4ec = []byte{
