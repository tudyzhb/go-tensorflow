...
package versions_go_proto // import "github.com/tensorflow/tensorflow/tensorflow/go/core/framework/versions_go_proto"
...
func (*VersionDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_versions_dcb18ae25200633f, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/versions.proto", fileDescriptor_versions_dcb18ae25200633f)
}

var fileDescriptor_versions_dcb18ae25200633f = []byte{
