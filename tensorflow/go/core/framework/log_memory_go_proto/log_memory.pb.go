...
package log_memory_go_proto // import "github.com/tensorflow/tensorflow/tensorflow/go/core/framework/log_memory_go_proto"
...
func (*MemoryLogStep) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_2e403e12edb6c478, []int{0}
}
...
func (*MemoryLogTensorAllocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_2e403e12edb6c478, []int{1}
}
...
func (*MemoryLogTensorDeallocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_2e403e12edb6c478, []int{2}
}
...
func (*MemoryLogTensorOutput) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_2e403e12edb6c478, []int{3}
}
...
func (*MemoryLogRawAllocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_2e403e12edb6c478, []int{4}
}
...
func (*MemoryLogRawDeallocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_2e403e12edb6c478, []int{5}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/log_memory.proto", fileDescriptor_log_memory_2e403e12edb6c478)
}

var fileDescriptor_log_memory_2e403e12edb6c478 = []byte{
