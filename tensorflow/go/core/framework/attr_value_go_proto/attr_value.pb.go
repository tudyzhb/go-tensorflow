...
package attr_value_go_proto // import "github.com/tensorflow/tensorflow/tensorflow/go/core/framework/attr_value_go_proto"
...
func (*AttrValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_attr_value_04bc13308cd4c07f, []int{0}
}
...
func _AttrValue_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 6: // value.type
		...
		x, err := b.DecodeVarint()
		m.Value = &AttrValue_Type{types_go_proto.DataType(x)}
		return true, err
	case 7: // value.shape
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
...
func (*AttrValue_ListValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_attr_value_04bc13308cd4c07f, []int{0, 0}
}
...
func (*NameAttrList) Descriptor() ([]byte, []int) {
	return fileDescriptor_attr_value_04bc13308cd4c07f, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/attr_value.proto", fileDescriptor_attr_value_04bc13308cd4c07f)
}

var fileDescriptor_attr_value_04bc13308cd4c07f = []byte{
