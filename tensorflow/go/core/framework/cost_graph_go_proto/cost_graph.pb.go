...
package cost_graph_go_proto // import "github.com/tensorflow/tensorflow/tensorflow/go/core/framework/cost_graph_go_proto"
...
func (*CostGraphDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_cost_graph_9153e60aba6b338f, []int{0}
}
...
func (*CostGraphDef_Node) Descriptor() ([]byte, []int) {
	return fileDescriptor_cost_graph_9153e60aba6b338f, []int{0, 0}
}
...
func (*CostGraphDef_Node_InputInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_cost_graph_9153e60aba6b338f, []int{0, 0, 0}
}
...
func (*CostGraphDef_Node_OutputInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_cost_graph_9153e60aba6b338f, []int{0, 0, 1}
}
...
func (*CostGraphDef_AggregatedCost) Descriptor() ([]byte, []int) {
	return fileDescriptor_cost_graph_9153e60aba6b338f, []int{0, 1}
}
...
func (dst *CostGraphDef_AggregatedCost) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CostGraphDef_AggregatedCost.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/cost_graph.proto", fileDescriptor_cost_graph_9153e60aba6b338f)
}

var fileDescriptor_cost_graph_9153e60aba6b338f = []byte{
