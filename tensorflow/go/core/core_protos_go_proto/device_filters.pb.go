...
func (*TaskDeviceFilters) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_filters_2ab18a21e84735ee, []int{0}
}
...
func (dst *TaskDeviceFilters) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TaskDeviceFilters.Merge(dst, src)
}
...
func (*JobDeviceFilters) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_filters_2ab18a21e84735ee, []int{1}
}
...
func (dst *JobDeviceFilters) XXX_Merge(src proto.Message) {
	xxx_messageInfo_JobDeviceFilters.Merge(dst, src)
}
...
func (*ClusterDeviceFilters) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_filters_2ab18a21e84735ee, []int{2}
}
...
func (dst *ClusterDeviceFilters) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ClusterDeviceFilters.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/device_filters.proto", fileDescriptor_device_filters_2ab18a21e84735ee)
}

var fileDescriptor_device_filters_2ab18a21e84735ee = []byte{
