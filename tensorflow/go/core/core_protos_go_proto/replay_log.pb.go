...
func (*NewReplaySession) Descriptor() ([]byte, []int) {
	return fileDescriptor_replay_log_5cb8701ff0365fc2, []int{0}
}
...
func (*ReplayOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_replay_log_5cb8701ff0365fc2, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/replay_log.proto", fileDescriptor_replay_log_5cb8701ff0365fc2)
}

var fileDescriptor_replay_log_5cb8701ff0365fc2 = []byte{
