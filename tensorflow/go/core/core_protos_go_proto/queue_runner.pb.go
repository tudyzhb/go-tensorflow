...
func (*QueueRunnerDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_queue_runner_9a7e55b5042576e2, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/queue_runner.proto", fileDescriptor_queue_runner_9a7e55b5042576e2)
}

var fileDescriptor_queue_runner_9a7e55b5042576e2 = []byte{
