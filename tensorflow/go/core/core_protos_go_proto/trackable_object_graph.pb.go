...
func (*TrackableObjectGraph) Descriptor() ([]byte, []int) {
	return fileDescriptor_trackable_object_graph_abb8c0f99289e4ac, []int{0}
}
...
func (dst *TrackableObjectGraph) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TrackableObjectGraph.Merge(dst, src)
}
...
func (*TrackableObjectGraph_TrackableObject) Descriptor() ([]byte, []int) {
	return fileDescriptor_trackable_object_graph_abb8c0f99289e4ac, []int{0, 0}
}
...
func (dst *TrackableObjectGraph_TrackableObject) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TrackableObjectGraph_TrackableObject.Merge(dst, src)
}
...
func (*TrackableObjectGraph_TrackableObject_ObjectReference) Descriptor() ([]byte, []int) {
	return fileDescriptor_trackable_object_graph_abb8c0f99289e4ac, []int{0, 0, 0}
}
...
func (dst *TrackableObjectGraph_TrackableObject_ObjectReference) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TrackableObjectGraph_TrackableObject_ObjectReference.Merge(dst, src)
}
...
func (*TrackableObjectGraph_TrackableObject_SerializedTensor) Descriptor() ([]byte, []int) {
	return fileDescriptor_trackable_object_graph_abb8c0f99289e4ac, []int{0, 0, 1}
}
...
func (dst *TrackableObjectGraph_TrackableObject_SerializedTensor) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TrackableObjectGraph_TrackableObject_SerializedTensor.Merge(dst, src)
}
...
func (*TrackableObjectGraph_TrackableObject_SlotVariableReference) Descriptor() ([]byte, []int) {
	return fileDescriptor_trackable_object_graph_abb8c0f99289e4ac, []int{0, 0, 2}
}
...
func (dst *TrackableObjectGraph_TrackableObject_SlotVariableReference) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TrackableObjectGraph_TrackableObject_SlotVariableReference.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/trackable_object_graph.proto", fileDescriptor_trackable_object_graph_abb8c0f99289e4ac)
}

var fileDescriptor_trackable_object_graph_abb8c0f99289e4ac = []byte{
