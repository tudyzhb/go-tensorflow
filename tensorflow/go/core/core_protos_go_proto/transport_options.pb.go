...
func (*RecvBufRespExtra) Descriptor() ([]byte, []int) {
	return fileDescriptor_transport_options_bdf9cd4ef23d33f2, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/transport_options.proto", fileDescriptor_transport_options_bdf9cd4ef23d33f2)
}

var fileDescriptor_transport_options_bdf9cd4ef23d33f2 = []byte{
