...
func (*SavedModel) Descriptor() ([]byte, []int) {
	return fileDescriptor_saved_model_b3536b7188b6764b, []int{0}
}
...
func (dst *SavedModel) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SavedModel.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/saved_model.proto", fileDescriptor_saved_model_b3536b7188b6764b)
}

var fileDescriptor_saved_model_b3536b7188b6764b = []byte{
